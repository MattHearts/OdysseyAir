...
<body>
    <div class="page">
        <div <?php if ($_SESSION['flightType'] == "return") {
                    echo "class='flight-results-display'";
                } else {
                    echo "class='flight-results-display-only-dep'";
                } ?>>
            <div class="flight-results-recap">
                <div class=flight-results-where>
                    ...
                    <?php if ($_SESSION['flightType'] == "return") {
                        echo "<p>" . $srch1->searchDepAirportR . " to " . $srch1->searchDestAirportR . "</p>";
                    } ?>
                </div>
            ...
            <div <?php if ($_SESSION['flightType'] == "return") {
                        echo "class='flight-result-boxes'";
                    } else {
                        echo "class='flight-result-boxes-only-dep'";
                    } ?>>
                <div <?php if ($_SESSION['flightType'] == "return") {
                            echo "class='result-departure'";
                        } else {
                            echo "class='result-departure-only'";
                        } ?>>
                    ...
                    <form id="myForm">
                        <div class="calendar" id="calendar-container">
                            <button type="button" class="day-3" name="dayMinus3" <?php if ($srch1->depDateMinus3 < date('Y-m-d')) {
                                                                                        echo 'disabled';
                                                                                    } ?>>
                            ...
                            <button type="button" class="day-2" name="dayMinus2" <?php if ($srch1->depDateMinus2 < date('Y-m-d')) {
                                                                                        echo 'disabled';
                                                                                    } ?>>
                                <div class="calendar-date">
                            ...
                            <button type="button" class="day-1" name="dayMinus1" <?php if ($srch1->depDateMinus1 < date('Y-m-d')) {
                                                                                        echo 'disabled';
                                                                                    } ?>>
                                <div class="calendar-date">
                            ...
                            <button type="button" class="day0" name="day0" <?php if ($srch1->searchDepDate < date('Y-m-d')) {
                                                                                echo 'disabled';
                                                                            } ?>>
                                <div class="calendar-date">
                            ...
                            <button type="button" class="day1" name="dayPlus1" <?php if ($srch1->depDatePlus1 < date('Y-m-d')) {
                                                                                    echo 'disabled';
                                                                                } ?>>
                                <div class="calendar-date">
                            ...
                            <button type="button" class="day2" name="dayPlus2" <?php if ($srch1->depDatePlus2 < date('Y-m-d')) {
                                                                                    echo 'disabled';
                                                                                } ?>>
                                <div class="calendar-date">
                            ...
                            <button type="button" class="day3" name="dayPlus3" <?php if ($srch1->depDatePlus3 < date('Y-m-d')) {
                                                                                    echo 'disabled';
                                                                                } ?>>
                                <div class="calendar-date">
                    ...
                    <div class="result-return">
                        ...
                        <form id="myForm2">
                            <div class="calendar_r">
                                <button type="button" class="day-3" name="dayMinus3R" <?php if ($srch1->depDateMinus3R < date('Y-m-d')) {
                                                                                            echo 'disabled';
                                                                                        } ?>>
                                    <div class="calendar-date">
                                ...
                                <button type="button" class="day-2" name="dayMinus2R" <?php if ($srch1->depDateMinus2R < date('Y-m-d')) {
                                                                                            echo 'disabled';
                                                                                        } ?>>
                                    <div class="calendar-date">
                                ...
                                <button type="button" class="day-1" name="dayMinus1R" <?php if ($srch1->depDateMinus1R < date('Y-m-d')) {
                                                                                            echo 'disabled';
                                                                                        } ?>>
                                    <div class="calendar-date">
                                ...
                                <button type="button" class="day0" name="day0R" <?php if ($srch1->searchDepDateR < date('Y-m-d')) {
                                                                                    echo 'disabled';
                                                                                } ?>>
                                    <div class="calendar-date">
                                ...
                                <button type="button" class="day1" name="dayPlus1R" <?php if ($srch1->depDatePlus1R < date('Y-m-d')) {
                                                                                        echo 'disabled';
                                                                                    } ?>>
                                    <div class="calendar-date">
                                ...
                                <button type="button" class="day2" name="dayPlus2R" <?php if ($srch1->depDatePlus2R < date('Y-m-d')) {
                                                                                        echo 'disabled';
                                                                                    } ?>>
                                    <div class="calendar-date">
                                ...
                                <button type="button" class="day3" name="dayPlus3R" <?php if ($srch1->depDatePlus3R < date('Y-m-d')) {
                                                                                        echo 'disabled';
                                                                                    } ?>>
                                    <div class="calendar-date">
    ...
    <div class="overall-results">
            ...
            <div class="synopsis-bottom">
                <div class="synopsis-bottom-left">
                    ...
                    <div class="small-letters"><b>Depart:</b> <?php echo $srch1->depDate . " at " . $srch1->depTime; ?><br>
                        ...
                        <b>Flight duration:</b> <?php echo $srch1->durationMin; ?> mins direct<br>
                    </div>
                    <h2 class="h2m5">&euro; <?php echo $srch1->pricePerPersonNum * $srch1->whosGoing; ?></h2>
                    <div class="small-letters"> Passengers: <?php echo $srch1->whosGoing . " x &euro;" . $srch1->pricePerPersonNum; ?></div>
                </div>
                <div class="synopsis-bottom-right">
                    ...
                    <?php if ($_SESSION['flightType'] == "return") { ?>
                        <div class="small-letters"><b>Depart:</b> <?php echo $srch1->depDateR . " at " . $srch1->depTimeR; ?><br>
                            ...
                            <b>Flight duration:</b> <?php echo $srch1->durationMinR; ?> mins direct<br>
                        </div>
                        <h2 class="h2m5">&euro; <?php echo $srch1->pricePerPersonNumR * $srch1->whosGoing; ?></h2>
                        <div class="small-letters"> Passengers: <?php echo $srch1->whosGoing . " x &euro;" . $srch1->pricePerPersonNumR; ?></div>
                </div>
                <div class="synopsis-bottom-right">
                <?php } else { ?>
        ...
        <div class="price-synopsis">
            ...
            <button onclick="addToSessionOverallPrice()" <?php if ($_SESSION['flightType'] == "return" && $srch1->isFlight == true && $srch1->isFlightR == true) {
                                                                echo "class='button-continue'";
                                                            } else if ($_SESSION['flightType'] == "one-way" && $srch1->isFlight == true) {
                                                                echo "class='button-continue'";
                                                            } else {
                                                                echo "class='button-not-continue'";
