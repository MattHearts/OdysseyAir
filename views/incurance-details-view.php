...
<div class="layout">
    <div class="forms">
        <h1 style="color:#12bbc7;">Travel Incurance</h1>
        ...
        <form method="post" id="insuranceForm">
            <div class="form-box">
                ...
                ?>
                    <div class="form-row">
                        <div class="form-label">
                            <label for="insurance<?php echo $x; ?>">
                                <h2><?php echo $pass1->passengerName[$x] . " " . $pass1->passengerSurname[$x]; ?></h2>
                            </label>
                        </div>
                ...
                <div class="terms">
                    ...
                    <br>
                    1. You are a Greek resident.<br>
                    2. You are not already travelling.<br>
                    3. You do not have any symptom or condition for which you have not had a diagnosis.<br>
                    4. You are not travelling with the intention of obtaining medical treatment.<br>
                    5. No-one travelling aged over 75 years old.<br>
                </div>
            </div>
